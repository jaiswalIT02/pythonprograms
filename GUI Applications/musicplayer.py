...
playlist=Listbox(root,selectmode=SINGLE,bg="white",fg="black",font=('Times new roman',15),width=40)
...
volumebutton=Button(root,text="volume")
volumebutton.config(font=('arial',10),bg="DodgerBlue2",fg="white",padx=7,pady=7)
volumebutton.grid(row=1,column=4)
